...
<body>
    ...
    <script>
        let modalBusquedaAlternativa = new bootstrap.Modal(document.getElementById('modalBusquedaAlternativa'));
        let numeroCompleto = '';
        ...
        // Agregar event listeners para generar código en tiempo real
        ...
        function llenarDatosEjemplo() {
            document.getElementById('codigo_entrada').value = '01';
            document.getElementById('numero_entrada').value = '1234567';
            document.getElementById('digito_verificador').value = '9';
            document.getElementById('ano').value = '2024';
            generarCodigo();
        }

        // Agregar botón de ejemplo (útil para testing)
